...
const localArticles = [
 ...
 {
  id: "investytsii-v-nerukhomist-irpin-bucha-2026",
  title: "Інвестиції в нерухомість Ірпеня, Бучі та Приірпіння: чи варто вкладати кошти у 2026 році",
  excerpt: "Аналітика ринку нерухомості Ірпеня, Бучі та Приірпіння. Квартири, земельні ділянки, комерційна нерухомість та найперспективніші локації для інвестування.",
