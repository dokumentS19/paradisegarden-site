...
const localArticles = [
  ...
  {
  id: "top-10-zhk-irpin-2026",
  title: "Топ-10 житлових комплексів Ірпеня: обираємо найкраще для життя у 2026 році",
  excerpt: "Огляд найкращих житлових комплексів Ірпеня, їх інфраструктури, розташування та переваг для комфортного життя.",
